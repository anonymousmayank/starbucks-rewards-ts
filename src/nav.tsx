...
const Nav: React.FC = () => {
    ...
    return (
        <>
            <div className='z-30 flex px-4 md:px-10 py-4 md:py-0 lg:pt-2 justify-between text-sm items-center bg-white sticky md:top-0 shadow-md inset-x-0'>
                <div className='font-bold uppercase tracking-widest flex items-center static'>
                    <svg xmlns="http://www.w3.org/2000/svg" className='h-10 w-10 md:h-14 md:w-14 mr-8' viewBox="0 0 62 62"
                        focusable="false">
                        <path fill="#006341"
                    ...
                    <div className='hidden md:flex flex-row space-x-5 relative pt-8'>
                        <NavLink to='/rewards' activeClassName='pb-8 lg:pb-10 shadow-inner'>Menu</NavLink>
                        <NavLink to='/rewards' activeClassName='pb-8 lg:pb-10 shadow-inner'>Rewards</NavLink>
                        <NavLink to='/gifts' activeClassName='pb-8 lg:pb-10 shadow-inner'>Gift Cards</NavLink>
                    </div>
                </div>
                <div className='hidden md:flex text-sm items-center font-semibold space-x-5'>
                    <a href="#" className='flex items-center mr-5'>
                        <span><svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-5 mr-3" viewBox="0 0 20 20"
                            fill="currentColor">
                    ...
                    <RoundedLink theme='black' href='#'>Sign up</RoundedLink>
                    <button
                        className='px-3 py-1 border border-black bg-black rounded-full text-sm text-white font-semibold'>Join
                        now</button>
                </div>
                <button className="px-4 cursor-pointer inline-block md:hidden"
                    onClick={() => {
                        if(!isAnimating){
            ...
            >
                ...
                leaveTo='opacity-0'
                >
                    <Dialog.Overlay className="fixed inset-0 bg-black z-20"></Dialog.Overlay>
                </Transition.Child>
                <Transition.Child
                as={Fragment}
                ...
                >
                    <div className="fixed flex flex-col top-0 bottom-0 right-0 pt-40 transform h-screen w-9/12 bg-primary-100 z-20">
                        <button>Menu</button>
